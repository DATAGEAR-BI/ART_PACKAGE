...
public class AuthContext : IdentityDbContext<AppUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArtStSystemPerfPerDate>().HasNoKey().ToView(null);
        modelBuilder.Entity<ArtStSystemPerfPerType>().HasNoKey().ToView(null);
        modelBuilder.Entity<ArtStSystemPerfPerStatus>().HasNoKey().ToView(null);
