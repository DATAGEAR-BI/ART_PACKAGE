...
namespace Data.Data.ECM
{
    public class EcmContext : DbContext
    {
        ...
        public virtual DbSet<SourceTypeDropDownView> SourceTypeDropDownViews { get; set; } = null!;
       // public virtual DbSet<ArtClearDetect> ArtClearDetects { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ArtStSanctionScreeningStatus>().HasNoKey().ToView(null);
            modelBuilder.Entity<ArtStSanctionListUpdate>().HasNoKey().ToView(null);
