...
namespace Data.Data.Segmentation
{
    public partial class ArtMebSegmentsV3Tb
    {
        ...
        public double? MaxTotalAmt { get; set; }
        public double? TotalCnt { get; set; }
        public double? TotalCreditAmount { get; set; }
        public double? AvgTotalCtAmt { get; set; }
        public double? MinTotalCtAmt { get; set; }
        public double? MaxTotalCtAmt { get; set; }
        public double? TotalCtCnt { get; set; }
