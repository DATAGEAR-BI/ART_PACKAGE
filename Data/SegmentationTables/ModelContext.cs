...
namespace Data.SegmentationTables
{
    public partial class ModelContext : DbContext
    {
        ...
        public virtual DbSet<ArtAlertsPerSegment> ArtAlertsPerSegments { get; set; } = null!;
        public virtual DbSet<ArtAlertsPerSegmentTb> ArtAlertsPerSegmentTbs { get; set; } = null!;
        public virtual DbSet<ArtAllSegmentCustCount> ArtAllSegmentCustCounts { get; set; } = null!;
        public virtual DbSet<ArtAllSegmentCustCountTb> ArtAllSegmentCustCountTbs { get; set; } = null!;
        public virtual DbSet<ArtAllSegmentsOutlier> ArtAllSegmentsOutliers { get; set; } = null!;
        public virtual DbSet<ArtAllSegmentsOutliersTb> ArtAllSegmentsOutliersTbs { get; set; } = null!;
        public virtual DbSet<ArtAllSegsFeatrsStatc> ArtAllSegsFeatrsStatcs { get; set; } = null!;
        public virtual DbSet<ArtAllSegsFeatrsStatcsTb> ArtAllSegsFeatrsStatcsTbs { get; set; } = null!;
        public virtual DbSet<ArtAllSegsOutliersLimit> ArtAllSegsOutliersLimits { get; set; } = null!;
        public virtual DbSet<ArtAllSegsOutliersLimitTb> ArtAllSegsOutliersLimitTbs { get; set; } = null!;
        public virtual DbSet<ArtChangedSegment> ArtChangedSegments { get; set; } = null!;
        public virtual DbSet<ArtChangedSegmentTb> ArtChangedSegmentTbs { get; set; } = null!;
        public virtual DbSet<ArtCustsPerType> ArtCustsPerTypes { get; set; } = null!;
        public virtual DbSet<ArtCustsPerTypeTb> ArtCustsPerTypeTbs { get; set; } = null!;
        public virtual DbSet<ArtIndustrySegment> ArtIndustrySegments { get; set; } = null!;
        public virtual DbSet<ArtIndustrySegmentTb> ArtIndustrySegmentTbs { get; set; } = null!;
        public virtual DbSet<ArtMebSegmentsV3> ArtMebSegmentsV3s { get; set; } = null!;
        public virtual DbSet<ArtMebSegmentsV3Tb> ArtMebSegmentsV3Tbs { get; set; } = null!;
        public virtual DbSet<ArtSegoutvsallcust> ArtSegoutvsallcusts { get; set; } = null!;
        public virtual DbSet<ArtSegoutvsallcustTb> ArtSegoutvsallcustTbs { get; set; } = null!;
        public virtual DbSet<ArtSegoutvsallout> ArtSegoutvsallouts { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ArtAlertsPerSegment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_ALERTS_PER_SEGMENT");
            ...
            modelBuilder.Entity<ArtAllSegmentCustCount>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_ALL_SEGMENT_CUST_COUNT");
            ...
            modelBuilder.Entity<ArtAllSegmentsOutlier>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_ALL_SEGMENTS_OUTLIERS");
            ...
            modelBuilder.Entity<ArtAllSegsFeatrsStatc>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_ALL_SEGS_FEATRS_STATCS");
            ...
            modelBuilder.Entity<ArtAllSegsOutliersLimit>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_ALL_SEGS_OUTLIERS_LIMIT");
            ...
            modelBuilder.Entity<ArtChangedSegment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_CHANGED_SEGMENT");
            ...
            modelBuilder.Entity<ArtCustsPerType>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_CUSTS_PER_TYPE");
            ...
            modelBuilder.Entity<ArtIndustrySegment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_INDUSTRY_SEGMENT");
            ...
            modelBuilder.Entity<ArtMebSegmentsV3>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_MEB_SEGMENTS_V3");
            ...
            modelBuilder.Entity<ArtSegoutvsallcust>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_SEGOUTVSALLCUST");
            ...
            modelBuilder.Entity<ArtSegoutvsallout>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("ART_SEGOUTVSALLOUT");
