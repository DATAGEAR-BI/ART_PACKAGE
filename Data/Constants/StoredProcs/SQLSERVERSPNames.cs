namespace Data.Constants.StoredProcs
{
    public static class SQLSERVERSPNames
    {
        ...
        public static readonly string ART_ST_SANCTION_SCREENING_STATUS = "[ART_DB].[ART_ST_SANCTION_SCREENING_STATUS]";
        public static readonly string ART_ST_SANCTION_LIST_UPDATE = "[ART_DB].[ART_ST_SANCTION_LIST_UPDATE]";
        ...
        public static readonly string ART_ST_DGAML_PARTIES_LIST_DETAILS_REPORT = "[ART_DB].[ART_ST_DGAML_PARTIES_LIST_DETAILS_REPORT]";
        public static readonly string ART_ST_DGAML_POLITICALLY_EXPOSED_REPORT = "[ART_DB].[ART_ST_DGAML_POLITICALLY_EXPOSED_REPORT]";
        public static readonly string ART_ST_DGAML_PARTIES_LIST_SUMMARY_REPORT = "[ART_DB].[ART_ST_DGAML_PARTIES_LIST_SUMMARY_REPORT]";
        public static readonly string ART_ST_DGAML_COMMENTS_DETAIL = "[ART_DB].[ART_ST_DGAML_COMMENTS_DETAIL]";
        public static readonly string ART_ST_DGAML_SUSPECTED_TRANSACTIONS_DETAIL = "[ART_DB].[ART_ST_DGAML_SUSPECTED_TRANSACTIONS_DETAIL]";
