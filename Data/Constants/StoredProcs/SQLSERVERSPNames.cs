namespace Data.Constants.StoredProcs
{
    public static class SQLSERVERSPNames
    {
        ...
        public static readonly string ART_ST_AML_ALERTS_PER_STATUS_NON_STAFF = "[ART_DB].[ART_ST_AML_ALERTS_PER_STATUS_NON_STAFF]";
        public static readonly string ART_ST_AML_ALERTS_PER_SCENARIO_NON_STAFF = "[ART_DB].[ART_ST_AML_ALERTS_PER_SCENARIO_NON_STAFF]";
        public static readonly string ART_ST_AML_ALERT_PER_OWNER_NON_STAFF = "[ART_DB].[ART_ST_AML_ALERT_PER_OWNER_NON_STAFF]";
        public static readonly string ART_ST_AML_ALERTS_PER_BRANCH_NON_STAFF = "[ART_DB].[ART_ST_AML_ALERTS_PER_BRANCH_NON_STAFF]";
