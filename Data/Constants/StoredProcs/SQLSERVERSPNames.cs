...
namespace Data.Constants.StoredProcs
{
    public static class SQLSERVERSPNames
    {
       ...
       public static readonly string ART_ST_CUSTOMERS_PER_CITY_U4 = "[ART_DB].[ART_ST_CUSTOMERS_PER_CITY_U4]";
       public static readonly string ART_ST_CUSTOMERS_RENEWAL_PER_MONTH_U3 = "[ART_DB].[ART_ST_CUSTOMERS_RENEWAL_PER_MONTH_U3]";
       public static readonly string ART_ST_CUSTOMERS_RENEWAL_PER_MONTH_U4 = "[ART_DB].[ART_ST_CUSTOMERS_RENEWAL_PER_MONTH_U4]";
