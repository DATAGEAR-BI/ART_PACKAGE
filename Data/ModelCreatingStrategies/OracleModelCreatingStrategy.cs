...
namespace Data.ModelCreatingStrategies
{
    public class OracleModelCreatingStrategy : IBaseModelCreatingStrategy
    {
        ...
        {
            modelBuilder.Entity<AuditTrailReport>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("AUDIT_TRAIL_REPORT");
            ...
            modelBuilder.Entity<ListAccessRightPerProfile>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("LIST_ACCESS_RIGHT_PER_PROFILE");
            ...
            modelBuilder.Entity<ListAccessRightPerRole>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("LIST_ACCESS_RIGHT_PER_ROLE");
            ...
            modelBuilder.Entity<SasUsersAndGroupsRole>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("SAS_USERS_AND_GROUPS_ROLES");
        ...
        public void OnFCFCORESegModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey( e => new { e.MonthKey , e.PartyNumber });

                entity.ToTable("MEB_SEGMENTS_V3");
                ...
                entity.Property(e => e.AvgTotalCAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("AVG_TOTAL_C_AMT");

                entity.Property(e => e.AvgTotalDAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("AVG_TOTAL_D_AMT");
                ...
                entity.Property(e => e.MaxTotalCAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("MAX_TOTAL_C_AMT");

                entity.Property(e => e.MaxTotalDAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("MAX_TOTAL_D_AMT");
                ...
                entity.Property(e => e.MinTotalCAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("MIN_TOTAL_C_AMT");

                entity.Property(e => e.MinTotalDAmt)
                    .HasColumnType("NUMBER")
                    .HasColumnName("MIN_TOTAL_D_AMT");
            ...
            modelBuilder.HasSequence("FSC_PARTY_HOUSEHOLD_DEF_SEQ");

            modelBuilder.HasSequence("SEQ_DIM_PARTY");

            modelBuilder.HasSequence("SNCT_COUNTRY_LKP_SEQ");

            modelBuilder.HasSequence("SNCT_CURRENCY_LKP_SEQ");

            modelBuilder.HasSequence("WATCH_LIST_SEQ");
        }
    }
}
