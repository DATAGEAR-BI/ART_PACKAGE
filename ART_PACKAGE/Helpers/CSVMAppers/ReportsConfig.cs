        ...
        public static readonly Dictionary<string, ReportConfig> CONFIG = new()
        {
            ...
            //        },
                              ...
                              DisplayNames = new Dictionary<string, DisplayNameAndFormat>
                    {
                            ...
                            {"CustomerCIF",new DisplayNameAndFormat { DisplayName ="Currency"}},
                            {"PrimaryOwner",new DisplayNameAndFormat { DisplayName ="Customer CIF"}},
                            {"CaseStatus",new DisplayNameAndFormat { DisplayName ="Case Status"}},
                    ...
                    },
            {
                              ...
                              DisplayNames = new Dictionary<string, DisplayNameAndFormat>
                    {
                            ...
                            {"BranchName",new DisplayNameAndFormat { DisplayName ="Branch Name"                         }},
                            {"ParentCaseId",new DisplayNameAndFormat { DisplayName ="ECM Parent" ,Template="hyperlink"  }},
                            {"ParentCaseStatus",new DisplayNameAndFormat { DisplayName ="Parent Case Status"                   }},
                            {"SubCaseId",new DisplayNameAndFormat { DisplayName ="ECM Request ID Sub",Template="hyperlink"}},
                            {"SubCaseStatus",new DisplayNameAndFormat { DisplayName ="Sub Case Status"                   }},
                    ...
                    },
            {
                        nameof(ArtEcmSlaViolatedCasesController).ToLower(),new ReportConfig
                        {
                              ...
                              DisplayNames = new Dictionary<string, DisplayNameAndFormat>{
                                ...
                                {"ViolatedTime",new DisplayNameAndFormat { DisplayName ="Violated Time"}},
