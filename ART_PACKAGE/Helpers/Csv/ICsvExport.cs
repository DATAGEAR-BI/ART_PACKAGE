...
namespace ART_PACKAGE.Helpers.Csv
{
    public interface ICsvExport
    {
        ...
        public bool ExportCustomData(ArtCustomReport report, ExportRequest exportRequest, string folderPath, string fileName, int fileNumber, string reportGUID, string tenantId);
