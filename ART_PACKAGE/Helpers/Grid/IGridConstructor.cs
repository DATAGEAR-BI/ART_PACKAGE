...
namespace ART_PACKAGE.Helpers.Grid
{
        ...
        where TModel : class where TRepo : IBaseRepo<TContext, TModel>
    {
        ...
        public Task<string> ExportGridToPDFUsingIText(ExportRequest exportRequest, string user, string gridId, string reportGUID, Expression<Func<TModel, bool>>? baseCondition = null);
