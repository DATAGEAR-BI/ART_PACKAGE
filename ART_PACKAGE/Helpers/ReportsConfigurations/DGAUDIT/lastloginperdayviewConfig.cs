...
{"Logindatetime" , new GridColumnConfiguration { DisplayName = "Login Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };

            ReportTitle = "User Last Login Per Day Report";
            ReportDescription = "This Report presents each user with last login dateime for each day";
