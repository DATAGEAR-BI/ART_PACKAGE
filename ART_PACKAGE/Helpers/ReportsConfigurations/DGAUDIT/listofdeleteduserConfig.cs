...
{
    public class listofdeleteduserConfig : ReportConfig
    {
        public listofdeleteduserConfig()
        {



            DisplayNames = new Dictionary<string, GridColumnConfiguration>(){ {"UserType" , new GridColumnConfiguration { DisplayName = "User Type"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },
...
{"LastLoginDate" , new GridColumnConfiguration { DisplayName = "Last Login Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "List Of Deleted Users";
            ReportDescription = "This Report presents all deleted users with the related informaton as below";
