...
{
    public class listofuserConfig : ReportConfig
    {
        public listofuserConfig()
        {
...
{"UserType" , new GridColumnConfiguration { DisplayName = "User Type"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },
...
{"CounterLock" , new GridColumnConfiguration { DisplayName = "Counter Lock"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },
...
{"Enable" , new GridColumnConfiguration { DisplayName = "Enable"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "List Of Users Report";
            ReportDescription = "This Report presents all users with the related information as below";
