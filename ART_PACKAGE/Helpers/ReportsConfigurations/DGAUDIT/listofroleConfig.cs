...
{
    public class listofroleConfig : ReportConfig
    {
        public listofroleConfig()
        {
...
{"RoleType" , new GridColumnConfiguration { DisplayName = "Role Type"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },
...
{"LastUpdatedDate" , new GridColumnConfiguration { DisplayName = "Last Updated Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "List Of Roles Report";
            ReportDescription = "This Report presents all roles with the related information as below";
