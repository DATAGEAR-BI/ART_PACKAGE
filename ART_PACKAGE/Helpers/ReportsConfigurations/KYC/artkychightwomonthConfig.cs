...
{
    public class artkychightwomonthConfig : ReportConfig
    {
        public artkychightwomonthConfig()
        {
...
{"NextUpdateDate" , new GridColumnConfiguration { DisplayName = "Next Update Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "High risk within 2 months customers Report";
            ReportDescription = "presents all high-risk customers need to be update their KYCs within 2 months with the related information below";
