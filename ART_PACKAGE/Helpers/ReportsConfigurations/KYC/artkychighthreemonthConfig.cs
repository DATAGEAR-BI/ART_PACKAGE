...
{
    public class artkychighthreemonthConfig : ReportConfig
    {
        public artkychighthreemonthConfig()
        {
...
{"NextUpdateDate" , new GridColumnConfiguration { DisplayName = "Next Update Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "High risk within 3 months customers Report";
            ReportDescription = "presents all high-risk customers need to be update their KYCs within 3 months with the related information below";
