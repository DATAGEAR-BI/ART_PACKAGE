...
{
    public class artkychighonemonthConfig : ReportConfig
    {
        public artkychighonemonthConfig()
        {
...
{"NextUpdateDate" , new GridColumnConfiguration { DisplayName = "Next Update Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "High risk within 1 month customers Report";
            ReportDescription = "presents all high-risk customers need to be update their KYCs within 1 month with the related information below";
