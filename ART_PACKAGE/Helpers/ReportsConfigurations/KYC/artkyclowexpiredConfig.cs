...
{
    public class artkyclowexpiredConfig : ReportConfig
    {
        public artkyclowexpiredConfig()
        {
...
{"NextUpdateDate" , new GridColumnConfiguration { DisplayName = "Next Update Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Low risk expired customers Report";
            ReportDescription = "presents all low-risk customers need to be update their expired KYCs with the related information below";
