...
{"NextUpdateDate" , new GridColumnConfiguration { DisplayName = "Next Update Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Low risk within 1 month customers Report";
            ReportDescription = "presents all low-risk customers need to be update their KYCs within 1 month with the related information below";
