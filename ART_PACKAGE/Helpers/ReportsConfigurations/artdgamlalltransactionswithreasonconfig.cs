...
{
    public class artdgamlalltransactionswithreasonconfig : ReportConfig
    {
        public artdgamlalltransactionswithreasonconfig()
        {
...
{"EquivalentAmount" , new GridColumnConfiguration { DisplayName = "Equivalent Amount"  , Format = "{0:n2}"  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } ,
            ...
            { "Source" , new GridColumnConfiguration { DisplayName = "Source", Format = "", Filter = "", Template = "", AggText = "", isLargeText = false } },
            ...
            ReportTitle = "All Transaction With Reason";
            ReportDescription = "presents all transactions with reasons for only staff and only for 6 months back (i.e. from system date to 6 months back) with the related information as below";
