...
{"EquivalentAmount" , new GridColumnConfiguration { DisplayName = "Equivalent Amount"  , Format = "{0:n2}"  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } ,
            ...
            { "OtherCustomerID" , new GridColumnConfiguration { DisplayName = "Other Customer Number", Format = "", Filter = "", Template = "", AggText = "", isLargeText = false } },
            { "OtherAccountNumber" , new GridColumnConfiguration { DisplayName = "Other Account Number", Format = "", Filter = "", Template = "", AggText = "", isLargeText = false } },
            { "OtherAccountName" , new GridColumnConfiguration { DisplayName = "Other Account Name", Format = "", Filter = "", Template = "", AggText = "", isLargeText = false } },
        };
