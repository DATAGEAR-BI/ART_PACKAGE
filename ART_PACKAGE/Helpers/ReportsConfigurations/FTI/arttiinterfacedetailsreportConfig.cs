...
{"ToBranch" , new GridColumnConfiguration { DisplayName = "To Branch"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Interface Details Report";
            ReportDescription = "This report produces a listing of items passed from Fusion Trade Innovation to each back office system like Postings, Foreign exchange deals etc..";
