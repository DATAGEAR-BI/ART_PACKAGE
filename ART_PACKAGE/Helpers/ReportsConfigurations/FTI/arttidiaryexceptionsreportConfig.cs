...
{"Active" , new GridColumnConfiguration { DisplayName = "Active"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Diary Exceptions Report";
            ReportDescription = "This report produces a list of diary activities that were not carried out when due because of exception conditions";
