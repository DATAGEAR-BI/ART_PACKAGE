...
{"Descr" , new GridColumnConfiguration { DisplayName = "Descr"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "OS Transactions Awaiti Apprl Report";
            ReportDescription = "This report produces information transactions awaiting credit approval only with the related master records and the related events have been initiated with the related status";
