...
{"Typeflag" , new GridColumnConfiguration { DisplayName = "Typeflag"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "OS Transactions By Gateway Report";
            ReportDescription = "This report produces information for master records that are not yet booked off or cancelled for only those transactions relating to customer gateway customers";
