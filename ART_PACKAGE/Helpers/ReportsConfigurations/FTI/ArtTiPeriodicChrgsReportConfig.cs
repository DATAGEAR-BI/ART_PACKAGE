...
{
    public class ArtTiPeriodicChrgsReportConfig : ReportConfig
    {
        public ArtTiPeriodicChrgsReportConfig()
        {
...
{"ChargeAmtEgp" , new GridColumnConfiguration { DisplayName = "ChargeAmtEgp"  , Format = "{0:n2}"  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Amortization Report";
            ReportDescription = "This report produces all transactions which have not yet expired and which have periodic charges either accruing or amortising within a period that you can specify";
        }
    }
}