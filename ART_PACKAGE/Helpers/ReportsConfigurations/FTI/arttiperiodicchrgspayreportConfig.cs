...
{"ChargeAmtEgp" , new GridColumnConfiguration { DisplayName = "ChargeAmtEgp"  , Format = "{0:n2}"  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Periodic CHRGs Payment Report";
            ReportDescription = "This report produces all transactions which have a Pay Charges event within a period that you can specify";
