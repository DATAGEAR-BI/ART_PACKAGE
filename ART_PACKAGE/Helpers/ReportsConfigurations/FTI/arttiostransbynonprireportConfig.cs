...
{
    public class arttiostransbynonprireportConfig : ReportConfig
    {
        public arttiostransbynonprireportConfig()
        {
...
{"Address1" , new GridColumnConfiguration { DisplayName = "Non-Principal Party"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },
...
{"Typeflag" , new GridColumnConfiguration { DisplayName = "Typeflag"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "OS Transactions By Non-Pri Report";
            ReportDescription = "This report produces information for non-principal parties instead of principal parties. All totals are in the reporting currency if one is specified, otherwise in base currency.";
