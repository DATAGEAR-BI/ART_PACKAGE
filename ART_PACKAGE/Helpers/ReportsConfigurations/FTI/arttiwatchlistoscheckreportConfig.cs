...
{"Lstmoduser" , new GridColumnConfiguration { DisplayName = "Lstmoduser"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "Watchlist - OS Check Report";
            ReportDescription = "This report produces lists of transactions that have been pended and are awaiting list checking.";
