...
{
    public class arttiacpostingscustreportConfig : ReportConfig
    {
        public arttiacpostingscustreportConfig()
        {
...
{"BranchName" , new GridColumnConfiguration { DisplayName = "Branch Name"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } } };
            ...
            ReportTitle = "A C Postings - Customers";
            ReportDescription = "This report produces all postings posted to an account by value date";
