...
{
    public class ArtStDgAmlPartiesListDetailsConfig : ReportConfig
    {

        public ArtStDgAmlPartiesListDetailsConfig()
        {
            ...
            DisplayNames = new Dictionary<string, GridColumnConfiguration>(){
                ...
                {"Dealing_with_the_bank_since_date" , new GridColumnConfiguration { DisplayName = "Dealing With The Bank Since Date"  , Format = ""  ,  Filter = "" , Template = "" , AggText = ""  , isLargeText = false   } },                                                                              
            ...
            ReportTitle = " Parties List Details Report";
            ReportDescription = "";
