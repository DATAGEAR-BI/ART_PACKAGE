...
namespace ART_PACKAGE.Controllers.FTI
{
    ...
    public class OSTransactionsByPrincipalController : BaseReportController<IBaseRepo<FTIContext, ArtTiOsTransByPrincipalReport>, FTIContext, ArtTiOsTransByPrincipalReport>
    {
