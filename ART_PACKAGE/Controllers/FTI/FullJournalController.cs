...
namespace ART_PACKAGE.Controllers.FTI
{
    ...
    {
        public FullJournalController(IGridConstructor<IBaseRepo<FTIContext, ArtTiFullJournalReport>, FTIContext, ArtTiFullJournalReport> gridConstructor) : base(gridConstructor)
        {
        }
