...
namespace ART_PACKAGE.Controllers.FTI
{
    ...
    {
        public OSTransactionsAwaitiApprlController(IGridConstructor<IBaseRepo<FTIContext, ArtTiOsTransAwaitiApprlReport>, FTIContext, ArtTiOsTransAwaitiApprlReport> gridConstructor) : base(gridConstructor)
        {
        }
