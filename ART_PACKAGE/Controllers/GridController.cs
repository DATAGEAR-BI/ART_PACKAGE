...
namespace ART_PACKAGE.Controllers
{
    public class GridController : Controller
    {
        ...
        public GridController(SasAmlContext dbfcfkc, IDropDownService dropDown, IPdfService pdfSrv, IHubContext<ExportHub> exportHub, UsersConnectionIds connections)
        {
