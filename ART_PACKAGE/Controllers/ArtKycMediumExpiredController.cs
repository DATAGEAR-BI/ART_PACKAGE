...
namespace ART_PACKAGE.Controllers
{
    public class ArtKycMediumExpiredController : Controller
    {
        ...
        public ArtKycMediumExpiredController(KYCContext dbfcfkc, IDropDownService dropDown, IPdfService pdfSrv)
        {
        ...
        {
            Dictionary<string, DisplayNameAndFormat> DisplayNames = ReportsConfig.CONFIG[nameof(ArtKycMediumExpiredController).ToLower()].DisplayNames;
