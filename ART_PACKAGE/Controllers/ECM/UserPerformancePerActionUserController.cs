...
namespace ART_PACKAGE.Controllers.ECM
{
    ...
    {
        public UserPerformancePerActionUserController(IGridConstructor<IBaseRepo<EcmContext, ArtUserPerformancePerActionUser>, EcmContext, ArtUserPerformancePerActionUser> gridConstructor) : base(gridConstructor)
        {
        }
        //{
