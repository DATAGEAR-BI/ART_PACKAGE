...
namespace ART_PACKAGE.Controllers.ECM
{
    ...
    {
        public UserPerformancePerUserAndActionController(IGridConstructor<IBaseRepo<EcmContext, ArtUserPerformPerUserAndAction>, EcmContext, ArtUserPerformPerUserAndAction> gridConstructor) : base(gridConstructor)
        {
        }
