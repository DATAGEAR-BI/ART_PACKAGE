...
{
    public class ArtKycMediumExpiredController : BaseReportController<KYCContext, ArtKycMediumExpired>
    {
        public ArtKycMediumExpiredController(IGridConstructor<KYCContext, ArtKycMediumExpired> gridConstructor) : base(gridConstructor)
        {
        }
