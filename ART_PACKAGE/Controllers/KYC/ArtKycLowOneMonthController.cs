...
namespace ART_PACKAGE.Controllers.KYC
{
    public class ArtKycLowOneMonthController : Controller
    {
        ...
        public ArtKycLowOneMonthController(KYCContext dbfcfkc, IDropDownService dropDown, IPdfService pdfSrv)
        {
        ...
        {
            Dictionary<string, DisplayNameAndFormat> DisplayNames = ReportsConfig.CONFIG[nameof(ArtKycLowOneMonthController).ToLower()].DisplayNames;
