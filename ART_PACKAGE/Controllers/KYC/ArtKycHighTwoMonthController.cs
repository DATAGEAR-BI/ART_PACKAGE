...
namespace ART_PACKAGE.Controllers.KYC
{
    ...
    {
        public ArtKycHighTwoMonthController(IGridConstructor<IBaseRepo<KYCContext, ArtKycHighTwoMonth>, KYCContext, ArtKycHighTwoMonth> gridConstructor) : base(gridConstructor)
        {
        }
