...
namespace ART_PACKAGE.Controllers.KYC
{
    ...
    {
        public ArtKycMediumThreeMonthController(IGridConstructor<IBaseRepo<KYCContext, ArtKycMediumThreeMonth>, KYCContext, ArtKycMediumThreeMonth> gridConstructor) : base(gridConstructor)
        {
        }
