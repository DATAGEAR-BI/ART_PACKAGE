...
{
    public class ArtAuditCorporateController : BaseReportController<KYCContext, ArtAuditCorporateView>
    {
        public ArtAuditCorporateController(IGridConstructor<KYCContext, ArtAuditCorporateView> gridConstructor) : base(gridConstructor)
        {
        }
