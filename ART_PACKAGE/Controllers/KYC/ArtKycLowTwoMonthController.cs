...
namespace ART_PACKAGE.Controllers.KYC
{
    ...
    {
        public ArtKycLowTwoMonthController(IGridConstructor<IBaseRepo<KYCContext, ArtKycLowTwoMonth>, KYCContext, ArtKycLowTwoMonth> gridConstructor) : base(gridConstructor)
        {
        }
