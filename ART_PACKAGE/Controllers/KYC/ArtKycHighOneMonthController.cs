...
namespace ART_PACKAGE.Controllers.KYC
{
    public class ArtKycHighOneMonthController : Controller
    {
        ...
        public ArtKycHighOneMonthController(KYCContext dbfcfkc, IDropDownService dropDown, IPdfService pdfSrv)
        {
        ...
        {
            Dictionary<string, DisplayNameAndFormat> DisplayNames = ReportsConfig.CONFIG[nameof(ArtKycHighOneMonthController).ToLower()].DisplayNames;
