...
{
    public class ArtKycHighOneMonthController : BaseReportController<KYCContext, ArtKycHighOneMonth>
    {
        public ArtKycHighOneMonthController(IGridConstructor<KYCContext, ArtKycHighOneMonth> gridConstructor) : base(gridConstructor)
        {
        }
