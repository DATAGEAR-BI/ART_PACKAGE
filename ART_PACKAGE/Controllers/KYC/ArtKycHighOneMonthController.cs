...
namespace ART_PACKAGE.Controllers.KYC
{
    ...
    {
        public ArtKycHighOneMonthController(IGridConstructor<IBaseRepo<KYCContext, ArtKycHighOneMonth>, KYCContext, ArtKycHighOneMonth> gridConstructor) : base(gridConstructor)
        {
        }
