...
{
    public class ArtKycExpiredIdController : BaseReportController<KYCContext, ArtKycExpiredId>
    {
        public ArtKycExpiredIdController(IGridConstructor<KYCContext, ArtKycExpiredId> gridConstructor) : base(gridConstructor)
        {
        }
