...
namespace ART_PACKAGE.Controllers.DGAML
{
    ...
    {
        public DGAMLArtScenarioAdminController(IGridConstructor<IBaseRepo<ArtDgAmlContext, ArtScenarioAdminView>, ArtDgAmlContext, ArtScenarioAdminView> gridConstructor) : base(gridConstructor)
        {
        }
