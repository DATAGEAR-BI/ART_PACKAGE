...
namespace ART_PACKAGE.Controllers.DGAML
{
    ...
    {
        public DGAMLCasesDetailsController(IGridConstructor<IBaseRepo<ArtDgAmlContext, ArtDgAmlCaseDetailView>, ArtDgAmlContext, ArtDgAmlCaseDetailView> gridConstructor) : base(gridConstructor)
        {
        }
