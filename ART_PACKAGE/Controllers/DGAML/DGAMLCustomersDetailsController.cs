...
namespace ART_PACKAGE.Controllers.DGAML
{
    ...
    {
        public DGAMLCustomersDetailsController(IGridConstructor<IBaseRepo<ArtDgAmlContext, ArtDgAmlCustomerDetailView>, ArtDgAmlContext, ArtDgAmlCustomerDetailView> gridConstructor) : base(gridConstructor)
        {
        }
