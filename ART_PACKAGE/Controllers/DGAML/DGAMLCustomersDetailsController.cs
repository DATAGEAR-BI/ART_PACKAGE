...
{
    public class DGAMLCustomersDetailsController : BaseReportController<IBaseRepo<ArtDgAmlContext, ArtDgAmlCustomerDetailView>, ArtDgAmlContext, ArtDgAmlCustomerDetailView>
    {
