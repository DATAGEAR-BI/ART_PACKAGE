...
{
    public class NonStaffGOAMLSANCTIONPerRegionController : Controller
    {
        ...
        public NonStaffGOAMLSANCTIONPerRegionController(ArtGoAmlContext context, IPdfService pdfSrv, IDropDownService dropSrv, ICsvExport csvSrv, IConfiguration config)
        {
        ...
        public IActionResult GetData([FromBody] StoredReq para)
        {
            ...
            {
                data = context.ExecuteProc<ART_ST_YEARLY_NON_STAFF_GOAML_SANCTION_PER_REGION>(SQLSERVERSPNames.ART_ST_YEARLY_NON_STAFF_GOAML_SANCTION_PER_REGION, summaryParams.ToArray());
            }
            else if (dbType == DbTypes.Oracle)
            {
                data = context.ExecuteProc<ART_ST_YEARLY_NON_STAFF_GOAML_SANCTION_PER_REGION>(ORACLESPName.ART_ST_YEARLY_NON_STAFF_GOAML_SANCTION_PER_REGION, summaryParams.ToArray());
            }
            ...
            var result = new
            {
                ...
                total = Data.Total,
                reportname = "NonStaffGOAMLSANCTIONPerRegion"
            };
        ...
        public async Task<IActionResult> ExportPdf([FromBody] StoredReq para)
        {
            ...
            ViewData["title"] = "Non-Staff GOAML Sanction Per Region Report";
            ViewData["desc"] = "";
