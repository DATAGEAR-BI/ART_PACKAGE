...
DropDownColumn = new Dictionary<string, List<dynamic>>
            ...
            KendoDataDesc<ART_ST_YEARLY_STAFF_GOAML_AML_PER_CRIME> Data = data.AsQueryable().CallData(para.req, columnsToDropDownd: DropDownColumn);
        ...
        public async Task<IActionResult> ExportPdf([FromBody] StoredReq para)
        {
            ...
            ViewData["title"] = "Staff GOAML AML Per Crime Report";
            ViewData["desc"] = "";
