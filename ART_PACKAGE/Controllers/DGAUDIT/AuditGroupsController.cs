...
namespace ART_PACKAGE.Controllers.Audit
{
    ...
    public class AuditGroupsController : Controller
    {
        ...
        public AuditGroupsController(ArtAuditContext _context, Microsoft.AspNetCore.Hosting.IHostingEnvironment env, IPdfService pdfSrv, IDropDownService dropSrv)
        {
