...
namespace ART_PACKAGE.Controllers.DGAUDIT
{
    ...
    public class ListOfUserController : BaseReportController<ArtAuditContext, ListOfUser>
    {
        public ListOfUserController(IGridConstructor<ArtAuditContext, ListOfUser> gridConstructor) : base(gridConstructor)
        {
        }
