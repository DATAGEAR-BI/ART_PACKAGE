...
namespace ART_PACKAGE.Controllers
{
    ...
    public class AuditGroupsController : Controller
    {
        ...
        public async Task<IActionResult> ExportPdf([FromBody] KendoRequest req)
        {
            ...
            ViewData["title"] = "Audit Groups Report";
            ViewData["desc"] = "This report Presents all events of groups and related information of maker and checker with the related information as below";
