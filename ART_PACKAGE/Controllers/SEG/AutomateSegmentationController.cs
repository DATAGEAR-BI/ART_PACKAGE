...
namespace ART_PACKAGE.Controllers.SEG
{
    public class AutomateSegmentationController : Controller
    {
        ...
        public AutomateSegmentationController(IHostEnvironment environment, SegmentationContext segContext)
        {
            _environment = environment;
            _path = Path.Combine(_environment.ContentRootPath, "Segmentation_2023-11-15.csv");
        ...
        public IActionResult ReadData()
        {
            ...
            List<MebSegmentV3AutomateDto> data = csv.GetRecords<MebSegmentV3AutomateDto>().Take(100).ToList();
            return Ok(data);
        }
