...
namespace ART_PACKAGE.Controllers
{
    public class ArtKycSummaryByRiskController : Controller
    {
        ...
        public ArtKycSummaryByRiskController(KYCContext dbfcfkc, IDropDownService dropDown, IPdfService pdfSrv)
        {
        ...
        {
            Dictionary<string, DisplayNameAndFormat> DisplayNames = ReportsConfig.CONFIG[nameof(ArtKycSummaryByRiskController).ToLower()].DisplayNames;
