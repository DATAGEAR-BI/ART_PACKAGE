...
namespace ART_PACKAGE.Controllers.FATCA
{
    ...
    {
        public FATCACasesDetailsController(IGridConstructor<IBaseRepo<FATCAContext, ArtFatcaCace>, FATCAContext, ArtFatcaCace> gridConstructor) : base(gridConstructor)
        {
        }
        /*
