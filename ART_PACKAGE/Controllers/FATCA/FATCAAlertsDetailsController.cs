...
namespace ART_PACKAGE.Controllers.FATCA
{
    ...
    {
        public FATCAAlertsDetailsController(IGridConstructor<IBaseRepo<FATCAContext, ArtFatcaAlert>, FATCAContext, ArtFatcaAlert> gridConstructor) : base(gridConstructor)
        {
        }
