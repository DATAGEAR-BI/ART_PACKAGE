...
namespace ART_PACKAGE.Controllers.FATCA
{
    ...
    {
        public FATCADetailsController(IGridConstructor<IBaseRepo<FATCAContext, ArtFatcaCustomer>, FATCAContext, ArtFatcaCustomer> gridConstructor) : base(gridConstructor)
        {
        }
