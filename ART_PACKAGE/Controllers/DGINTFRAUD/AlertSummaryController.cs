...
namespace ART_PACKAGE.Controllers.DGINTFRAUD
{
    ...
    {
        private readonly DGINTFRAUDContext _context;
        private readonly IConfiguration _config;
        private readonly string dbType;

        public AlertSummaryController(DGINTFRAUDContext _context, IConfiguration config)
        {
        ...
        public IActionResult GetData([FromBody] StoredReq para)
        {
            ...
            if (dbType == DbTypes.Oracle)
            {
                ...
                chart2data = _context.ExecuteProc<ArtStDgAmlAlertPerOwner>(ORACLESPName.ART_ST_DGAML_ALERTS_PER_OWNER, chart2Params.ToArray());
